...
└── README.md
How to Open
Download IBM_Marketing___Risk_Analysis_Dashboard.pbix
Open in Power BI Desktop (free download from Microsoft)
If data doesn't load: Transform Data → Data Source Settings → update path to your local CSV
Author
Kabeer Khan — Data Analyst 📧 kabeerk992@gmail.com 🔗 LinkedIn | GitHub
